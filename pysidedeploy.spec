...
mode = standalone
macos.permissions =
extra_args = --quiet --msvc=latest --noinclude-qt-translations --enable-plugin=pyside6 --lto=no --nofollow-import-to=pytest,tests --include-data-dir=resources/native/windows=native/windows --include-qt-plugins=sensible --assume-yes-for-downloads
