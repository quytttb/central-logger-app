...
- **Kiến trúc UI:** Typography và icon dùng `UiLabel` / `UiIcon` (`import components`); layout/chrome dùng Qt Quick + `Colors.qml`. Không thêm native QML plugin bên ngoài PySide6.
